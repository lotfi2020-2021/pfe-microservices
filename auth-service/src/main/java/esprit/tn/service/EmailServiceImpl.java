...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    @Async
    public void sendEmaiListUsers(List<String> toList, String subject, String content) {
        try {
    ...
    public String buildEmailVerifyMail(String token) {
        String url = environment.getProperty("app.root.frontend") + "/confirmation-email/"+ token;
    ...
    @Override
    public String buildDemandeBody( ) {

        return buildDemandeBody(

                "demande entreprise",
                "demande envoyée avec succee ,nous vous contacterons dès que possible"
        );
    ...
    @Override
    public String buildDemandeAdminBody() {
        return buildDemandeBody(

                "demande entreprise",
                "demande entreprise ajoutée, vérifier la plate-forme"
        );
    }
    ...
    private String buildDemandeBody( String emailBodyHeader, String emailBodyDetail) {
        return "<div style=\"margin: 0 auto; width: 500px; text-align: center; background: #ffffff; border-radius: 5px; border: 3px solid #838383;\">" +
                "<h2 style=\"background: #838383; padding: 15px; margin: 0; font-weight: 700; font-size: 24px; color: #ffffff;\">" + emailBodyHeader + "</h2>" +
                "<p style=\"padding: 20px; font-size: 20px; color: #202020;\">" + emailBodyDetail + "</p>" +
